    ...
    <div className="flex flex-wrap gap-2 border-b border-gray-200 bg-gray-50 p-2 rounded-t-xl">
      <div className="flex items-center gap-1 border-r border-gray-300 pr-2">
        ...
        <button
          ...
          className={`rounded p-1.5 text-sm font-medium transition-colors ${
            editor.isActive('underline') ? 'bg-gray-200 text-black' : 'text-gray-600 hover:bg-gray-200'
          }`}
          title="Subrayado"
        >
          U
        ...
        <button
          ...
          className={`rounded p-1.5 text-sm font-medium transition-colors ${
            editor.isActive('strike') ? 'bg-gray-200 text-black' : 'text-gray-600 hover:bg-gray-200'
          }`}
          title="Tachado"
        >
          S
      ...
      <div className="flex items-center gap-1 border-r border-gray-300 pr-2">
        <button
          ...
          className={`rounded p-1.5 text-sm font-medium transition-colors ${
            editor.isActive('heading', { level: 1 }) ? 'bg-gray-200 text-black' : 'text-gray-600 hover:bg-gray-200'
          }`}
          title="Título 1"
        >
          H1
        ...
        <button
          ...
          className={`rounded p-1.5 text-sm font-medium transition-colors ${
            editor.isActive('heading', { level: 2 }) ? 'bg-gray-200 text-black' : 'text-gray-600 hover:bg-gray-200'
          }`}
          title="Título 2"
        >
          H2
        ...
        <button
          ...
          className={`rounded p-1.5 text-sm font-medium transition-colors ${
            editor.isActive('heading', { level: 3 }) ? 'bg-gray-200 text-black' : 'text-gray-600 hover:bg-gray-200'
          }`}
          title="Título 3"
        >
          H3
      ...
      <div className="flex items-center gap-1 border-r border-gray-300 pr-2">
        <button
          ...
          className={`rounded p-1.5 text-sm font-medium transition-colors ${
            editor.isActive({ textAlign: 'left' }) ? 'bg-gray-200 text-black' : 'text-gray-600 hover:bg-gray-200'
          }`}
        ...
        <button
          ...
          className={`rounded p-1.5 text-sm font-medium transition-colors ${
            editor.isActive({ textAlign: 'center' }) ? 'bg-gray-200 text-black' : 'text-gray-600 hover:bg-gray-200'
          }`}
          title="Centrar"
        >
          Centro
        ...
        <button
          ...
          className={`rounded p-1.5 text-sm font-medium transition-colors ${
            editor.isActive({ textAlign: 'right' }) ? 'bg-gray-200 text-black' : 'text-gray-600 hover:bg-gray-200'
          }`}
