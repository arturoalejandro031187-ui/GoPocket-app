...
export function ProductGallery({ images = [], title }: ProductGalleryProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div 
        ref={imgContainerRef}
        className="relative aspect-[4/5] w-full overflow-hidden rounded-[2rem] bg-white shadow-sm sm:aspect-square md:aspect-[4/5] xl:aspect-square"
          ...
          <div className="flex gap-4 overflow-x-auto pb-4 pt-2 scrollbar-hide snap-x px-1">
            {safeImages.map((img, idx) => (
              <button
                ...
                className={`relative h-20 w-20 flex-none snap-start overflow-hidden rounded-2xl transition-all duration-300 ease-out ${
                  selectedIndex === idx 
