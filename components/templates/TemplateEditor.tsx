            ...
            {b.type === 'image' ? (
              <div className="mt-3 grid gap-3">
                ...
                {availableImages.length > 0 && (b as any)?.is_slot === false && (
                  <div className="rounded-2xl border border-brand-pink/20 bg-pink-50/50 p-3">
                    ...
                    <div className="grid grid-cols-4 gap-2">
                      {availableImages.map((imgUrl, imgIdx) => (
                        <button
                          ...
                          className="group relative aspect-square overflow-hidden rounded-xl border-2 border-gray-200 hover:border-brand-pink transition-all"
                        >
                          <img
                            src={imgUrl}
                            alt={`Imagen ${imgIdx + 1}`}
                          ...
                          />
                          <div className="absolute inset-0 bg-brand-pink/0 group-hover:bg-brand-pink/20 transition-all flex items-center justify-center">
                            <span className="opacity-0 group-hover:opacity-100 text-white font-bold text-xs bg-brand-pink px-2 py-1 rounded-lg">
                              Usar
                            </span>
                          </div>
                        </button>
