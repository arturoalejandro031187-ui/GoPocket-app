    ...
    const sections: Array<{ title?: string; items: NavItem[] }> = [
      ...
      },
      {
        ...
        items: [
          ...
          { label: '📹 GoPocket Live', href: '/dashboard/live', tone: 'pink' },
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-end gap-3 px-4 py-2">
        ...
        {(planType === 'pro' || planType === 'platinum') && (
          <div className="hidden sm:flex flex-col items-end mr-1 leading-tight">
            <span className={`bg-clip-text text-transparent text-[10px] font-black uppercase tracking-wider ${planType === 'platinum' ? 'bg-gradient-to-r from-amber-500 to-yellow-500' : 'bg-gradient-to-r from-brand-pink to-pink-600'}`}>
            ...
            {open ? (
              ...
              >
                ...
                <div className="mb-2 rounded-2xl bg-gray-50 px-3 py-2 text-[11px] text-gray-600 ring-1 ring-black/5">
                  ...
                  {(planType === 'pro' || planType === 'platinum') && (
                    <div className={`mt-1 flex items-center gap-1 font-bold ${planType === 'platinum' ? 'text-amber-600' : 'text-brand-pink'}`}>
