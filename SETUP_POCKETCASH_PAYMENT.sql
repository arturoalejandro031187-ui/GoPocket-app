-- ============================================
-- SETUP PAGO CON POCKETCASH (RPC ATÓMICO)
-- ============================================
-- Ejecuta este script para permitir que el backend descuente saldo
-- de múltiples órdenes a la vez de forma segura.
...
begin
  ...
  -- 2. Bloquear wallet (lectura consistente)
